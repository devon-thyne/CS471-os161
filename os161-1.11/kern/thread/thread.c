...
thread_create(const char *name)
{
	...
	DEBUG(0x010/*DB_THREAD*/ , "New Thread Created Successfully");
...
thread_destroy(struct thread *thread)
{
	...
	DEBUG(0x010/*DB_THREAD*/, "Thread Destroyed Successfully.");
}
...
exorcise(void)
{
	...
	DEBUG(0x010/*DB_THREAD*/, "Zombies Exorcised Successfully.");	
}
